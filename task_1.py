...
# Создание подкласса ExtendedCase
...
# Переопределение метода print_test_case_info в подклассе ExtendedCase
    def print_test_case_info(self):
        super().print_test_case_info()
        print(f"Предусловие: {self.precondition}"
              f"\nОкружение: {self.environment}")

# Вызов метода print_test_case_info для объекта case класса ExtendedCase
